                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customer.store') }}">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="preferred_method_to_contact" class="col-md-4 col-form-label text-md-right">{{ __('Preferred Method to Contact') }}</label>

                            <div class="col-md-6">
                                <select id="preferred_method_to_contact" type="text" class="form-control @error('preferred_method_to_contact') is-invalid @enderror" name="preferred_method_to_contact" value="{{ old('preferred_method_to_contact') }}" required autocomplete="preferred_method_to_contact">
                                ...
                                @error('preferred_method_to_contact')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
