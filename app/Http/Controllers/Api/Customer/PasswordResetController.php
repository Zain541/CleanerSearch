...
class PasswordResetController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (!$customer)
            return response()->json([
                'message' => 'We can\'t find a customer with that e-mail address.'
            ], 404);
        $passwordReset = PasswordReset::updateOrCreate(
          ...
          $data = ['url' =>  url('/api/customer/password/find/'.$passwordReset->token)];
    ...
    public function find($token)
    {
        ...
        return view('customer.password.reset',compact('reset_credentials'));
    }
     /**
     * Reset password
     *
    ...
    public function reset(Request $request)
    {
        ...
        $customer->save();
        $passwordReset->delete();
        return view('customer.password.success');
    }
}